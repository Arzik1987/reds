...
dgp.piston <- function(box, n.points, distr = "laths", nval = 5, pts = 0, use.pts = FALSE, thr = 0.4){
  ...
  low <- c(30, 0.005, 0.002, 1000, 90000, 290, 340)
  up <- c(60, 0.02, 0.01, 5000, 110000, 296, 360)

  y <- apply(d.scale(d, low, up), 1, piston)
  y <- ifelse(y < thr, 1, 0)
