...
get.labs.box <- function(box = NULL, n.points = 0, laths = TRUE, pts = 0, use.pts = FALSE, dgp,
  ...
  if(dgp == "1"){
    res <- dgp1(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "2"){
    res <- dgp2(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "3"){
    res <- dgp3(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "4"){
    res <- dgp4(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "5"){
    res <- dgp5(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "6"){
    res <- dgp6(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "7"){
    res <- dgp7(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "8"){
    res <- dgp8(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts)
  } else if(dgp == "9"){
    ...
    res <- dgp.borehole(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.borehole)
  } else if(dgp == "piston"){
    ...
    res <- dgp.moon10hdc1(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.moon10hdc1)
    ...
    res <- dgp.linketal06simple(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.linketal06simple)
  } else if(dgp == "linketal06sin"){
    res <- dgp.linketal06sin(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.linketal06sin)
  } else if(dgp == "loepetal13"){
    res <- dgp.loepetal13(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.loepetal13)
    ...
    res <- dgp.ishigami(box = box, n.points = n.points, laths = laths, pts = pts, use.pts = use.pts, thr = thr.ishigami)
...
get.data <- function(box, n.points, laths){
